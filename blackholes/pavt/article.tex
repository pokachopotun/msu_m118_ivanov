...
conclude, that every node with index less than i in the topological sort will be reachable from topsort[i].
...
iBlackhole algorithm was implemented in accordance with the pseudocode in th original article. Divide and Conquer heuristic were not used for it.
...
and self-loops are omitted when reading graph from file.
