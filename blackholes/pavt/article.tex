...
We will need the following statement to discuss issues of the known approaches.
\begin{lemma}
...
\begin{figure}[H]
	...
	\caption{Special nodes in a graph with two roots.}
