...
Set of all roots of blackhole is called balckhole basis
\end{definition}

\begin{definition}{Simple blackhole. \\}
A blackhole is called simple if its basis has consist of a single node, i.e. it has single root.
\end{definition}

\begin{definition}{Comples blackhole. \\}
