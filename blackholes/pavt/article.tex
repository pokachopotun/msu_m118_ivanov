...
blackhole basis candidates and sorts unproper ones out. If $IsBasis$ returns False on a basis candidate, this candidate is to be omitted.
...
Thus we return to TopSort algorithm and we have a valid basis of a blackhole.
...
but experimental results demostrate its efficiency.
